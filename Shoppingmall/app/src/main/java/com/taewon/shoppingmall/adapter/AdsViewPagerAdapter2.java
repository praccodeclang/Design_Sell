...
public class AdsViewPagerAdapter2 extends RecyclerView.Adapter<AdsViewPagerAdapter2.ViewHolder> {
    Context context;
    ArrayList<AdsItem> items;
    FirebaseStorage storage;
    public AdsViewPagerAdapter2(Context context, ArrayList<AdsItem> items){
    ...
    @NonNull
    @Override
    public AdsViewPagerAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_viewpager_ads, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdsViewPagerAdapter2.ViewHolder holder, int position) {
